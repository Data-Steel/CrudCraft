...
/**
 * Represents a blog post. Demonstrates soft deletes, auditing, relationships, searchable fields,
 * validation, editable stubs, List DTOs, and projection fields.
 */
@Entity
...
public class Post {
    ...
    @Dto
    @Searchable
    // Explicit enum contract in generated DTO/search metadata.
    @EnumString(values = {"DRAFT", "PUBLISHED", "ARCHIVED"})
    ...
    @Embedded private SoftDeleteExtension softDelete = new SoftDeleteExtension();
