...
/**
 * Concrete Tutorial entity extending Content. Demonstrates inheritance - DTOs will include both
 * Tutorial-specific fields and inherited fields from Content (title, body, author, publishedAt,
 * status, etc.).
 */
@Entity
@CrudCrafted
