...
/**
 * Concrete Article entity extending Content. Demonstrates inheritance - this will generate full
 * CRUD endpoints with fields from both Article and the parent Content class (title, body, author,
 * etc.).
 */
@Entity
@CrudCrafted
