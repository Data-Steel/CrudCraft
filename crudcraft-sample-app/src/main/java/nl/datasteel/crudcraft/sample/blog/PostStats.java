...
/**
 * Represents statistics for a blog post. Demonstrates one-to-one relationships and PATCH_ONLY
 * template (stats can only be modified via PATCH, not full replacement).
 */
@Entity
