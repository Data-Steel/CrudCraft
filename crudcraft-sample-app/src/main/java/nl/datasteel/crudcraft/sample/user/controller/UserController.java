...
public class UserController {
    ...
    @Operation(
            ...
            description = "Partially updates an existing User entity identified by ID. Returns the updated entity."
    )
    @ApiResponses({
    ...
    @ApiResponses(@ApiResponse(responseCode = "200", description = "Search results for User entities"))
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(
            ...
            description = "Updates multiple User entities in a single request. Each entity must include its ID. Returns all updated entities."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Creates or updates multiple User entities in a single request. Returns all created or updated entities."
    )
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "User entities created or updated successfully"),
            @ApiResponse(responseCode = "400", description = "Invalid request data")
    })
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(
            ...
            description = "Retrieves lightweight references to User entities with support for pagination and filtering."
    )
    @ApiResponses(@ApiResponse(responseCode = "200", description = "Paginated list of User references"))
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @ApiResponses(@ApiResponse(responseCode = "204", description = "User entities deleted successfully"))
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(
            ...
            description = "Partially updates multiple User entities in a single request. Each entity must include its ID. Returns all updated entities."
    )
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "User entities partially updated successfully"),
            @ApiResponse(responseCode = "400", description = "Invalid request data")
    })
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @ApiResponses(@ApiResponse(responseCode = "200", description = "User entities retrieved successfully"))
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(
            ...
            description = "Creates a new User entity with the provided data. Returns the created entity with generated ID."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Updates an existing User entity identified by ID. Returns the updated entity."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Creates multiple User entities in a single request. Returns all created entities with generated IDs."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Retrieves all User entities with support for pagination, sorting, and filtering via search parameters."
    )
    @ApiResponses(@ApiResponse(responseCode = "200", description = "Paginated list of User entities"))
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(
            ...
            description = "Validates User data without persisting it. Returns validation errors if any."
    )
