...
/**
 * Represents a blog author who can write multiple posts. Demonstrates basic CRUD operations,
 * searchable fields, one-to-many relationships, List DTOs, and CrudTemplate.FULL with all endpoints
 * enabled.
 */
@Entity
