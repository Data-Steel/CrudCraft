...
/**
 * Represents a tag that can be applied to multiple posts. Demonstrates many-to-many relationships
 * and IMMUTABLE_WRITE template (tags can be created but not modified after creation).
 */
@Entity
