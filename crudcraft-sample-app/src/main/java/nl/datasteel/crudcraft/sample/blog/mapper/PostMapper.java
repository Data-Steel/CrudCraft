...
/**
 * Generated Mapper layer stub for Post. @CrudCraft:generated @CrudCraft:editable
 *
 * <p>This Mapper stub extends CrudCraft's base implementation. Override methods to customise
 * behaviour.
 *
 * <p>You are allowed to modify this file. It extends CrudCraft's abstract base (PostMapperBase)
 ...
 *
 * <p>Generation context: - Source model: Post - Package: nl.datasteel.crudcraft.sample.blog.mapper
 * - Generator: MapperGenerator - Generation time: 2025-11-16T21:29:13.682623464Z - CrudCraft
 * version: null
 *
...
// MapStruct method annotations describe the generated mapping contract in this editable sample.
@SuppressWarnings("checkstyle:MissingJavadocMethod")
public interface PostMapper
        extends EntityMapper<Post, PostRequestDto, PostResponseDto, PostRef, UUID> {
    @Override
    @Mapping(target = "author", source = "authorId", qualifiedByName = "PostMapAuthor")
    @Mapping(target = "category", source = "categoryId", qualifiedByName = "PostMapCategory")
    @Mapping(target = "tags", source = "tagIds", qualifiedByName = "PostMapTagSet")
    @Mapping(target = "stats", source = "statsId", qualifiedByName = "PostMapPostStats")
    ...
    @Override
    @Mapping(target = "author", qualifiedByName = "PostToAuthorRef")
    @Mapping(target = "category", qualifiedByName = "PostToCategoryRef")
    ...
    default UUID getIdFromRequest(PostRequestDto request) {
        try {
            ...
            throw new MapperException(
                    "Failed to read 'id' property from request DTO: " + request.getClass(), e);
        }
    }
