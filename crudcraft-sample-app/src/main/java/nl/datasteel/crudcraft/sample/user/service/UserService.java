...
/**
 * Generated Service layer stub for User. @CrudCraft:generated @CrudCraft:editable
 *
 * <p>This Service stub extends CrudCraft's base implementation. Override methods to customise
 * behaviour.
 *
 * <p>You are allowed to modify this file. It extends CrudCraft's abstract base (UserServiceBase)
 ...
 *
 * <p>Generation context: - Source model: User - Package: nl.datasteel.crudcraft.sample.user.service
...
public class UserService
        extends AbstractCrudService<User, UserRequestDto, UserResponseDto, UserRef, UUID> {
