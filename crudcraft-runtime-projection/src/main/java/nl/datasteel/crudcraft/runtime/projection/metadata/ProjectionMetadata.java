...
package nl.datasteel.crudcraft.runtime.projection.metadata;
...
public interface ProjectionMetadata<D> {
     ...
     *
     * @return ordered attribute metadata list
     */
    ...
    interface Attribute {
         ...
         *
         * @return entity attribute path
         */
        String path();

        /**
         * DTO field name for this attribute. Defaults to {@link #path()} for backwards
         * compatibility.
         *
         * @return DTO field name used for field-level security checks
         */
        default String dtoFieldName() {
            return path();
        }
         ...
         *
         * @return nested metadata or {@code null}
         */
         ...
         *
         * @return {@code true} when attribute is a collection association
         */
        boolean collection();
