...
/**
 * Maps DTO classes to entity paths at runtime using reflection. When no compile-time {@link
 * ProjectionMetadata} is available this mapper constructs the necessary JPA Criteria projection
 * selections based on field names and {@code @ProjectionField} annotations.
 */
public class ProjectionMapper {

    /**
     * The field resolver used to map DTO fields to entity attributes. This resolver can be
     * customized to change how fields are resolved.
     */
    private final ProjectionFieldResolver fieldResolver;

    /**
     * Constructs a ProjectionMapper using the default field resolver. This resolver uses reflection
     * to map DTO fields to entity attributes. This constructor is useful when no compile-time
     * metadata is available, allowing for dynamic projection mapping at runtime.
     */
    ...
    /**
     * Constructs a ProjectionMapper with a custom field resolver. This allows for custom resolution
     * logic if needed.
     *
     ...
     * @param from root or join from which projection fields are resolved
     * @param dtoType DTO type to construct
     * @param <D> DTO type
     * @return DTO constructor selection
     */
    ...
    /**
     * Join the given From with the specified path, creating a left join for each segment in the
     * path.
     *
    ...
    /**
     * Resolve a Path relative to the provided From. This method assumes the path is relative to the
     * current entity or join.
     */
