...
public interface CriteriaProjectionBuilder {
    ...
    /**
     * Builds a JPA Criteria query for the given entity type and DTO type. This method constructs a
     * CriteriaQuery that selects the DTO type based on the provided ProjectionQuery.
     *
