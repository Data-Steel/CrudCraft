...
/**
 * Adapter that converts entity-based exports to map-based exports for use with ExportUtil. This
 * class bridges entity mode with the existing DTO-based export infrastructure.
 */
public class EntityExportAdapter {
    ...
    @SuppressFBWarnings(
            ...
            justification = "Spring manages these collaborators and owns their lifecycle.")
    public EntityExportAdapter(
     ...
     * @param specification optional specification applied while fetching entities
     * @param <T> the entity type
     * @return an iterator of maps representing entities
     */
    public <T> @NonNull Iterator<Map<String, Object>> createIterator(
            @NonNull Class<T> entityClass,
            @NonNull ExportRequest exportRequest,
            int limit,
            int pageSize,
            Specification<T> specification) {
        return new EntityMapIterator<>(entityClass, exportRequest, limit, pageSize, specification);
    }
     ...
     * @param <T> entity type
     * @return iterator over exported rows
     */
    public <T> @NonNull Iterator<Map<String, Object>> createIterator(
            @NonNull Class<T> entityClass,
            @NonNull ExportRequest exportRequest,
            int limit,
            int pageSize) {
        return createIterator(entityClass, exportRequest, limit, pageSize, null);
    }
    ...
    private class EntityMapIterator<T> implements Iterator<Map<String, Object>> {
        ...
        private void fetch() {
            ...
            Page<T> entityPage =
                    entityExportService.fetchWithRelationships(
                            entityClass,
                            exportRequest,
