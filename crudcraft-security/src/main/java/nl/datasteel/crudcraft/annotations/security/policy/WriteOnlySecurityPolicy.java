 ...
 */
public class WriteOnlySecurityPolicy implements CrudSecurityPolicy {

    @Override
    public final String getSecurityExpression(CrudEndpoint endpoint) {
        return switch (endpoint) {
            case POST, PUT, PATCH, BULK_CREATE, BULK_UPDATE, BULK_PATCH, BULK_UPSERT,
                    BULK_DELETE, DELETE -> "permitAll()";
            default -> "denyAll()";
        };
    }
}
