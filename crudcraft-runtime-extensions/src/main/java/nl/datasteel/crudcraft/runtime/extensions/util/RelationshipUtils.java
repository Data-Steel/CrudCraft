...
import nl.datasteel.crudcraft.annotations.InternalOnly;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;


/**
 * Compatibility facade for the relationship utility now owned by runtime-core.
 *
 * @deprecated use {@link nl.datasteel.crudcraft.runtime.util.RelationshipUtils}.
 *     This class will be removed in 2.1.0
 */
@Deprecated(since = "1.0.10", forRemoval = true)
@InternalOnly(
        "Internal compatibility facade; use nl.datasteel.crudcraft.runtime.util.RelationshipUtils.")
public final class RelationshipUtils {
     ...
     *
     * <p>This compatibility implementation remains local to runtime-extensions so existing
     * module-path users can still reflect into generated metadata packages in the same module.
     * New callers should use {@link nl.datasteel.crudcraft.runtime.util.RelationshipUtils}.
     *
