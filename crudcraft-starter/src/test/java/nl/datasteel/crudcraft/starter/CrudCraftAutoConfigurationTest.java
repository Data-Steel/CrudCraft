...
import nl.datasteel.crudcraft.starter.search.CrudCraftSearchAutoConfiguration;
...
class CrudCraftAutoConfigurationTest {
    ...
    private final ReactiveWebApplicationContextRunner reactiveRunner =
            new ReactiveWebApplicationContextRunner()
                    .withUserConfiguration(CrudCraftAutoConfiguration.class);
    ...
    @Test
    void searchAutoConfigRegistersSearchPropertiesSeparately() {
        new ApplicationContextRunner()
                .withUserConfiguration(CrudCraftSearchAutoConfiguration.class)
                .run(context -> assertNotNull(context.getBean(CrudCraftSearchProperties.class)));
    }
