 ...
 *
 * <p>The cache uses {@link ConcurrentHashMap#computeIfAbsent(Object, java.util.function.Function)}
 * so concurrent first access for the same entity class publishes a single metadata instance without
