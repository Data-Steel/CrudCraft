...
/**
 * 409 Conflict — relationship constraint violation. This exception is thrown when an operation
 * violates a relationship constraint, such as attempting to delete an entity that is still
