...
public final class PurchaseRequestDtoProjectionMetadata implements ProjectionMetadata<PurchaseRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("reference","reference",() -> null,false,null),new Attr("customerId","customerId",() -> null,false,null));

    @Override
    public Class<PurchaseRequestDto> dtoType() {
        return PurchaseRequestDto.class;
    }
