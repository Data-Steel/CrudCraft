 ...
 */
@Schema(
        description = "Reference DTO for Purchase"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record PurchaseRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<PurchaseRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<PurchaseRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public PurchaseRef build() {
            return new PurchaseRef(this.id);
        }
    }
}
