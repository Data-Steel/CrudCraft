...
public interface SearchTagMapper extends EntityMapper<SearchTag, SearchTagRequestDto, SearchTagResponseDto, SearchTagRef, UUID> {
    /**
     ...
     */
    @Override
    SearchTag fromRequest(SearchTagRequestDto request);
     ...
     */
    @Override
    SearchTag update(@MappingTarget SearchTag entity, SearchTagRequestDto request);
    ...
    SearchTag patch(@MappingTarget SearchTag entity, SearchTagRequestDto request);
     ...
     */
    @Override
    SearchTagResponseDto toResponse(SearchTag entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    SearchTagRef toRef(SearchTag entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(SearchTagRequestDto request) {
        try {
