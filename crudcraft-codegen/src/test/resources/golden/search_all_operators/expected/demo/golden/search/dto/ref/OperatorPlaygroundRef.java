package demo.golden.search.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for OperatorPlayground"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record OperatorPlaygroundRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<OperatorPlaygroundRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<OperatorPlaygroundRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public OperatorPlaygroundRef build() {
            return new OperatorPlaygroundRef(this.id);
        }
    }
}
