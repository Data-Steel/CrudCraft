 ...
 */
@Schema(
        description = "Reference DTO for SearchTag"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SearchTagRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<SearchTagRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SearchTagRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public SearchTagRef build() {
            return new SearchTagRef(this.id);
        }
    }
}
