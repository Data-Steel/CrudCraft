...
public final class OperatorPlaygroundRequestDtoProjectionMetadata implements ProjectionMetadata<OperatorPlaygroundRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("tagIds","tagIds",() -> null,true,null));

    @Override
    public Class<OperatorPlaygroundRequestDto> dtoType() {
        return OperatorPlaygroundRequestDto.class;
    }
