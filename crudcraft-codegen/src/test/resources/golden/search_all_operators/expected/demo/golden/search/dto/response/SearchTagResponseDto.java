 ...
 */
@Schema(
        description = "Response DTO for SearchTag"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SearchTagResponseDto(@NotNull UUID id, @Nullable String label) {
    private static final FieldSecurityMetadata<SearchTagResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("label", dto -> dto.label(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SearchTagResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public SearchTagResponseDto build() {
            return new SearchTagResponseDto(this.id, this.label);
        }
    }
}
