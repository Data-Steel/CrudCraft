...
public final class OperatorPlaygroundResponseDtoProjectionMetadata implements ProjectionMetadata<OperatorPlaygroundResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("title","title",() -> null,false,null),new Attr("score","score",() -> null,false,null),new Attr("publishedAt","publishedAt",() -> null,false,null),new Attr("labels","labels",() -> null,true,null),new Attr("tags","tags",() -> null,true,null),new Attr("attributes","attributes",() -> null,false,null));

    @Override
    public Class<OperatorPlaygroundResponseDto> dtoType() {
        return OperatorPlaygroundResponseDto.class;
    }
