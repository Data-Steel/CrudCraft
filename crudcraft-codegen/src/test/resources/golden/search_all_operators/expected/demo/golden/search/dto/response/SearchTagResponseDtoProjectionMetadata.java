...
public final class SearchTagResponseDtoProjectionMetadata implements ProjectionMetadata<SearchTagResponseDto> {
    ...
    @Override
    public Class<SearchTagResponseDto> dtoType() {
        return SearchTagResponseDto.class;
    }
