...
public final class SearchTagRequestDtoProjectionMetadata implements ProjectionMetadata<SearchTagRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<SearchTagRequestDto> dtoType() {
        return SearchTagRequestDto.class;
    }
