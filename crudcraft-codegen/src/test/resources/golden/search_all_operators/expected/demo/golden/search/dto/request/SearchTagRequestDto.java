 ...
 *
 * <p>Nullness: request DTO instances for SearchTag are non-null. Fields may be null unless Jakarta validation marks them required; PATCH treats null according to mapper patch semantics, while PUT supplies replacement values.
 */
@Schema(
        description = "Create/update DTO for SearchTag"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SearchTagRequestDto() {
    private static final FieldSecurityMetadata<SearchTagRequestDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of());

    public static FieldSecurityMetadata<SearchTagRequestDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        public SearchTagRequestDto build() {
            return new SearchTagRequestDto();
        }
    }
}
