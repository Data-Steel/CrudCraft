 ...
 */
package demo.golden.claimscoped.projection;

import demo.golden.claimscoped.dto.request.TenantNoteRequestDtoProjectionMetadata;
import demo.golden.claimscoped.dto.response.TenantNoteResponseDtoProjectionMetadata;
...
public class GeneratedProjectionMetadataRegistry implements ProjectionMetadataRegistry {
    ...
    public GeneratedProjectionMetadataRegistry() {
        register(new TenantNoteRequestDtoProjectionMetadata());
        register(new TenantNoteResponseDtoProjectionMetadata());
    }
