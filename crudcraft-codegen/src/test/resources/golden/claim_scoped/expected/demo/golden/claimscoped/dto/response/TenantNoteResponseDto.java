 ...
 */
package demo.golden.claimscoped.dto.response;
 ...
 */
@Schema(
        description = "Response DTO for TenantNote"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record TenantNoteResponseDto(@NotNull UUID id, @Nullable String tenantId,
        @Nullable UUID ownerId, @Nullable String body) {
    private static final FieldSecurityMetadata<TenantNoteResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<TenantNoteResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public TenantNoteResponseDto build() {
            return new TenantNoteResponseDto(this.id, this.tenantId, this.ownerId, this.body);
        }
    }
}
