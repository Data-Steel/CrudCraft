...
public final class TenantNoteResponseDtoProjectionMetadata implements ProjectionMetadata<TenantNoteResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("tenantId","tenantId",() -> null,false,null),new Attr("ownerId","ownerId",() -> null,false,null),new Attr("body","body",() -> null,false,null));

    @Override
    public Class<TenantNoteResponseDto> dtoType() {
        return TenantNoteResponseDto.class;
    }
