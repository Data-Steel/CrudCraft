 ...
 */
package demo.golden.claimscoped.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for TenantNote"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record TenantNoteRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<TenantNoteRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<TenantNoteRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public TenantNoteRef build() {
            return new TenantNoteRef(this.id);
        }
    }
}
