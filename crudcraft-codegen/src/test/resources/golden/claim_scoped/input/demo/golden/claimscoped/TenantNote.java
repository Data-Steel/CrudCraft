...
package demo.golden.claimscoped;
...
@TenantScoped(field = "tenantId", claim = "tenant")
@OwnedBy(field = "ownerId", claim = "subject")
public class TenantNote {
    @Id @Dto(ref = true) private UUID id;
    @Dto @Request private String tenantId;
    @Dto @Request private UUID ownerId;
    @Dto @Request private String body;
}
