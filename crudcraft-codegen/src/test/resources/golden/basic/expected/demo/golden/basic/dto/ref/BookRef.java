package demo.golden.basic.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Book"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record BookRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<BookRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<BookRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public BookRef build() {
            return new BookRef(this.id);
        }
    }
}
