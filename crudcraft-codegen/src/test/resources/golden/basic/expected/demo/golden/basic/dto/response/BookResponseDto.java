 ...
 */
package demo.golden.basic.dto.response;
 ...
 */
@Schema(
        description = "Response DTO for Book"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record BookResponseDto(@NotNull UUID id, @Nullable @NotBlank String title,
        @Nullable BigDecimal price) {
    private static final FieldSecurityMetadata<BookResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<BookResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public BookResponseDto build() {
            return new BookResponseDto(this.id, this.title, this.price);
        }
    }
}
