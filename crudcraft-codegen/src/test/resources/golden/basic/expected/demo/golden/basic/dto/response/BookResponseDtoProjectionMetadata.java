...
public final class BookResponseDtoProjectionMetadata implements ProjectionMetadata<BookResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("title","title",() -> null,false,null),new Attr("price","price",() -> null,false,null));

    @Override
    public Class<BookResponseDto> dtoType() {
