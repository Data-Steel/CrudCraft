 ...
 */
package demo.golden.basic.search;
...
public class BookSearchRequest implements SearchRequest<Book>, Serializable {
    ...
    public BookSearchRequest(BookSearchRequest other) {
        if (other != null) {
            this.title = other.title;
            this.titleOp = other.titleOp;
            this.price = other.price;
            this.priceOp = other.priceOp;
    ...
    public List<SearchRequest.SearchCriterion> requestedSearchCriteria() {
        ...
        if (getPrice() != null) {
            criteria.add(new SearchRequest.SearchCriterion("price", getPriceOp()));
        }
        return criteria;
    }
