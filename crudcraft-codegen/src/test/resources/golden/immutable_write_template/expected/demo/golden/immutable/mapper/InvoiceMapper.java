package demo.golden.immutable.mapper;
...
public interface InvoiceMapper extends EntityMapper<Invoice, InvoiceRequestDto, InvoiceResponseDto, InvoiceRef, UUID> {
    /**
     ...
     */
    @Override
    Invoice fromRequest(InvoiceRequestDto request);
     ...
     */
    @Override
    Invoice update(@MappingTarget Invoice entity, InvoiceRequestDto request);
    ...
    Invoice patch(@MappingTarget Invoice entity, InvoiceRequestDto request);
     ...
     */
    @Override
    InvoiceRef toRef(Invoice entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(InvoiceRequestDto request) {
        try {
