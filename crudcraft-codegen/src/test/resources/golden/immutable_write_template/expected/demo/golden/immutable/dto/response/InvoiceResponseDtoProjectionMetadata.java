...
public final class InvoiceResponseDtoProjectionMetadata implements ProjectionMetadata<InvoiceResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("number","number",() -> null,false,null),new Attr("amount","amount",() -> null,false,null));

    @Override
    public Class<InvoiceResponseDto> dtoType() {
        return InvoiceResponseDto.class;
    }
