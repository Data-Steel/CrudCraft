 ...
 */
package demo.golden.immutable.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Invoice"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record InvoiceRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<InvoiceRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<InvoiceRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public InvoiceRef build() {
            return new InvoiceRef(this.id);
        }
    }
}
