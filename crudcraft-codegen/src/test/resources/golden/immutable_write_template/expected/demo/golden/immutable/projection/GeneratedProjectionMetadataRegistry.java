 ...
 */
package demo.golden.immutable.projection;

import demo.golden.immutable.dto.request.InvoiceRequestDtoProjectionMetadata;
import demo.golden.immutable.dto.response.InvoiceResponseDtoProjectionMetadata;
...
public class GeneratedProjectionMetadataRegistry implements ProjectionMetadataRegistry {
    ...
    public GeneratedProjectionMetadataRegistry() {
        register(new InvoiceRequestDtoProjectionMetadata());
        register(new InvoiceResponseDtoProjectionMetadata());
    }
