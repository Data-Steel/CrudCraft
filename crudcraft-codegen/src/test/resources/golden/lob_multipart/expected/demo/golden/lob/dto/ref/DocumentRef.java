package demo.golden.lob.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Document"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record DocumentRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<DocumentRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<DocumentRef> fieldSecurityMetadata() {
