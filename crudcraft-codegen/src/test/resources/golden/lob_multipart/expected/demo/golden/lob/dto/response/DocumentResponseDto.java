 ...
 */
package demo.golden.lob.dto.response;
 ...
 */
@Schema(
        description = "Response DTO for Document"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record DocumentResponseDto(@NotNull UUID id, @Nullable String name,
        @NotNull byte[] content) {
    private static final FieldSecurityMetadata<DocumentResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<DocumentResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public DocumentResponseDto build() {
            return new DocumentResponseDto(this.id, this.name, this.content);
        }
    }
}
