 ...
 */
package demo.golden.lob.mapper;
...
public interface DocumentMapper extends EntityMapper<Document, DocumentRequestDto, DocumentResponseDto, DocumentRef, UUID> {
    /**
     ...
     */
    @Override
    Document fromRequest(DocumentRequestDto request);
     ...
     */
    @Override
    Document update(@MappingTarget Document entity, DocumentRequestDto request);
    ...
    Document patch(@MappingTarget Document entity, DocumentRequestDto request);
    ...
    @Mapping(
            target = "content",
            expression = "java(entity.getContent())"
    )
     ...
     */
    @Override
    DocumentRef toRef(Document entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(DocumentRequestDto request) {
        try {
