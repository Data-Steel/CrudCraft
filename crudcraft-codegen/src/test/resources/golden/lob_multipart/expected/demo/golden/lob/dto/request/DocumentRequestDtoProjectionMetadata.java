...
public final class DocumentRequestDtoProjectionMetadata implements ProjectionMetadata<DocumentRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null),new Attr("content","content",() -> null,false,null));

    @Override
    public Class<DocumentRequestDto> dtoType() {
        return DocumentRequestDto.class;
    }
