 ...
 */
package demo.golden.lob.projection;

import demo.golden.lob.dto.request.DocumentRequestDtoProjectionMetadata;
import demo.golden.lob.dto.response.DocumentResponseDtoProjectionMetadata;
...
public class GeneratedProjectionMetadataRegistry implements ProjectionMetadataRegistry {
    ...
    public GeneratedProjectionMetadataRegistry() {
        register(new DocumentRequestDtoProjectionMetadata());
        register(new DocumentResponseDtoProjectionMetadata());
    }
