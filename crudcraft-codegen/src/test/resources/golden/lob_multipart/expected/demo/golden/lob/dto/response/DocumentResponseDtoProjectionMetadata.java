...
public final class DocumentResponseDtoProjectionMetadata implements ProjectionMetadata<DocumentResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("content","content",() -> null,false,null));

    @Override
    public Class<DocumentResponseDto> dtoType() {
        return DocumentResponseDto.class;
    }
