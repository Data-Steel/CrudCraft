 ...
 */
@Schema(
        description = "Response DTO for CatalogItem"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CatalogItemResponseDto(@NotNull UUID id, @Nullable String name,
        @Nullable String description) {
    private static final FieldSecurityMetadata<CatalogItemResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<CatalogItemResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CatalogItemResponseDto build() {
            return new CatalogItemResponseDto(this.id, this.name, this.description);
        }
    }
}
