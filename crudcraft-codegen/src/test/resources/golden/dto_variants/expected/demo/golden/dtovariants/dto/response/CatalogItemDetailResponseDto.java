 ...
 */
package demo.golden.dtovariants.dto.response;
 ...
 */
@Schema(
        description = "Response DTO Detail for CatalogItem"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CatalogItemDetailResponseDto(@NotNull UUID id, @Nullable String name,
        @Nullable String description) {
    private static final FieldSecurityMetadata<CatalogItemDetailResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<CatalogItemDetailResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CatalogItemDetailResponseDto build() {
            return new CatalogItemDetailResponseDto(this.id, this.name, this.description);
        }
    }
}
