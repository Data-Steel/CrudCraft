...
public final class CatalogItemDetailResponseDtoProjectionMetadata implements ProjectionMetadata<CatalogItemDetailResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("description","description",() -> null,false,null));

    @Override
    public Class<CatalogItemDetailResponseDto> dtoType() {
        return CatalogItemDetailResponseDto.class;
    }
