...
public final class CatalogItemRequestDtoProjectionMetadata implements ProjectionMetadata<CatalogItemRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null),new Attr("description","description",() -> null,false,null));

    @Override
    public Class<CatalogItemRequestDto> dtoType() {
        return CatalogItemRequestDto.class;
    }
