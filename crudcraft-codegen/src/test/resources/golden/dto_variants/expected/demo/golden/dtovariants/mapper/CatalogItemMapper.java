package demo.golden.dtovariants.mapper;
...
public interface CatalogItemMapper extends EntityMapper<CatalogItem, CatalogItemRequestDto, CatalogItemResponseDto, CatalogItemRef, UUID> {
    /**
     ...
     */
    @Override
    CatalogItem fromRequest(CatalogItemRequestDto request);
     ...
     */
    @Override
    CatalogItem update(@MappingTarget CatalogItem entity, CatalogItemRequestDto request);
    ...
    CatalogItem patch(@MappingTarget CatalogItem entity, CatalogItemRequestDto request);
     ...
     */
    @Override
    CatalogItemResponseDto toResponse(CatalogItem entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    CatalogItemRef toRef(CatalogItem entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(CatalogItemRequestDto request) {
        try {
    ...
    CatalogItemListResponseDto toListResponse(CatalogItem entity);

    CatalogItemDetailResponseDto toDetailResponse(CatalogItem entity);
}
