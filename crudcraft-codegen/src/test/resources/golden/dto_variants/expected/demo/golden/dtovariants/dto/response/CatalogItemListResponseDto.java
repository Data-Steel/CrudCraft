 ...
 */
@Schema(
        description = "Response DTO List for CatalogItem"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CatalogItemListResponseDto(@NotNull UUID id, @Nullable String name) {
    private static final FieldSecurityMetadata<CatalogItemListResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("name", dto -> dto.name(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CatalogItemListResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CatalogItemListResponseDto build() {
            return new CatalogItemListResponseDto(this.id, this.name);
        }
    }
}
