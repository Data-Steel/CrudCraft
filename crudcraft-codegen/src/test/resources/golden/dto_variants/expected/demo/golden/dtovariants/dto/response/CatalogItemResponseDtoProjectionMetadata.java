...
public final class CatalogItemResponseDtoProjectionMetadata implements ProjectionMetadata<CatalogItemResponseDto> {
    ...
    @Override
    public Class<CatalogItemResponseDto> dtoType() {
        return CatalogItemResponseDto.class;
    }
