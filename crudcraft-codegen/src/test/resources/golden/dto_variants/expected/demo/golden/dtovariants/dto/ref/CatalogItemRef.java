 ...
 */
package demo.golden.dtovariants.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for CatalogItem"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CatalogItemRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<CatalogItemRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CatalogItemRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CatalogItemRef build() {
            return new CatalogItemRef(this.id);
        }
    }
}
