...
public final class CatalogItemListResponseDtoProjectionMetadata implements ProjectionMetadata<CatalogItemListResponseDto> {
    ...
    @Override
    public Class<CatalogItemListResponseDto> dtoType() {
        return CatalogItemListResponseDto.class;
    }
