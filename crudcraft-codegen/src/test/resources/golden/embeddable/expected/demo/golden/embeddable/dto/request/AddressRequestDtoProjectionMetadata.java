...
public final class AddressRequestDtoProjectionMetadata implements ProjectionMetadata<AddressRequestDto> {
    ...
    @Override
    public Class<AddressRequestDto> dtoType() {
        return AddressRequestDto.class;
    }
