 ...
 */
@Schema(
        description = "Response DTO for CustomerRecord"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CustomerRecordResponseDto(@NotNull UUID id, @Nullable String name,
        @Nullable String street, @Nullable String city) {
    private static final FieldSecurityMetadata<CustomerRecordResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<CustomerRecordResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CustomerRecordResponseDto build() {
            return new CustomerRecordResponseDto(this.id, this.name, this.street, this.city);
        }
    }
}
