 ...
 */
@Schema(
        description = "Reference DTO for CustomerRecord"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CustomerRecordRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<CustomerRecordRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CustomerRecordRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CustomerRecordRef build() {
            return new CustomerRecordRef(this.id);
        }
    }
}
