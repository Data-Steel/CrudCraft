...
public final class CustomerRecordResponseDtoProjectionMetadata implements ProjectionMetadata<CustomerRecordResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("street","street",() -> null,false,null),new Attr("city","city",() -> null,false,null));

    @Override
    public Class<CustomerRecordResponseDto> dtoType() {
        return CustomerRecordResponseDto.class;
    }
