 ...
 *
 * <p>Nullness: request DTO instances for Address are non-null. Fields may be null unless Jakarta validation marks them required; PATCH treats null according to mapper patch semantics, while PUT supplies replacement values.
 *
 ...
 */
@Schema(
        description = "Create/update DTO for Address"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AddressRequestDto(@Nullable String street, @Nullable String city) {
    private static final FieldSecurityMetadata<AddressRequestDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("street", dto -> dto.street(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("city", dto -> dto.city(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AddressRequestDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AddressRequestDto build() {
            return new AddressRequestDto(this.street, this.city);
        }
    }
}
