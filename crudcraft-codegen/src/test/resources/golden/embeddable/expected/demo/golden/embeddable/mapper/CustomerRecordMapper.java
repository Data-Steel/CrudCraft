package demo.golden.embeddable.mapper;
...
public interface CustomerRecordMapper extends EntityMapper<CustomerRecord, CustomerRecordRequestDto, CustomerRecordResponseDto, CustomerRecordRef, UUID> {
    /**
     ...
     */
    @Override
    CustomerRecord fromRequest(CustomerRecordRequestDto request);
     ...
     */
    @Override
    CustomerRecord update(@MappingTarget CustomerRecord entity, CustomerRecordRequestDto request);
    ...
    CustomerRecord patch(@MappingTarget CustomerRecord entity, CustomerRecordRequestDto request);
     ...
     */
    @Override
    CustomerRecordResponseDto toResponse(CustomerRecord entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    CustomerRecordRef toRef(CustomerRecord entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(CustomerRecordRequestDto request) {
        try {
