 ...
 */
@Schema(
        description = "Response DTO for Address"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AddressResponseDto(@Nullable String street, @Nullable String city) {
    private static final FieldSecurityMetadata<AddressResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("street", dto -> dto.street(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("city", dto -> dto.city(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AddressResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AddressResponseDto build() {
            return new AddressResponseDto(this.street, this.city);
        }
    }
}
