...
public final class CustomerRecordRequestDtoProjectionMetadata implements ProjectionMetadata<CustomerRecordRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null),new Attr("street","street",() -> null,false,null),new Attr("city","city",() -> null,false,null));

    @Override
    public Class<CustomerRecordRequestDto> dtoType() {
        return CustomerRecordRequestDto.class;
    }
