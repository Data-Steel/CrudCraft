package demo.golden.omit.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Article"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ArticleRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<ArticleRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<ArticleRef> fieldSecurityMetadata() {
