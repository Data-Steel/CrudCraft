package demo.golden.omit.dto.response;
 ...
 */
@Schema(
        description = "Response DTO for Article"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ArticleResponseDto(@NotNull UUID id, @Nullable String title,
        @Nullable String summary) {
    private static final FieldSecurityMetadata<ArticleResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<ArticleResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public ArticleResponseDto build() {
            return new ArticleResponseDto(this.id, this.title, this.summary);
        }
    }
}
