...
public final class ArticleResponseDtoProjectionMetadata implements ProjectionMetadata<ArticleResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("title","title",() -> null,false,null),new Attr("summary","summary",() -> null,false,null));

    @Override
    public Class<ArticleResponseDto> dtoType() {
        return ArticleResponseDto.class;
    }
