...
public final class ArticleRequestDtoProjectionMetadata implements ProjectionMetadata<ArticleRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("title","title",() -> null,false,null),new Attr("summary","summary",() -> null,false,null));

    @Override
    public Class<ArticleRequestDto> dtoType() {
        return ArticleRequestDto.class;
    }
