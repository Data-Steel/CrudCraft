package demo.golden.omit.mapper;
...
public interface ArticleMapper extends EntityMapper<Article, ArticleRequestDto, ArticleResponseDto, ArticleRef, UUID> {
    /**
     ...
     */
    @Override
    Article fromRequest(ArticleRequestDto request);
     ...
     */
    @Override
    Article update(@MappingTarget Article entity, ArticleRequestDto request);
    ...
    Article patch(@MappingTarget Article entity, ArticleRequestDto request);
     ...
     */
    @Override
    ArticleRef toRef(Article entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(ArticleRequestDto request) {
        try {
