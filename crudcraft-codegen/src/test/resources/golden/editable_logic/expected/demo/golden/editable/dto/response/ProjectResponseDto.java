 ...
 */
package demo.golden.editable.dto.response;
 ...
 */
@Schema(
        description = "Response DTO for Project"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ProjectResponseDto(@NotNull UUID id, @Nullable String name) {
    private static final FieldSecurityMetadata<ProjectResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("name", dto -> dto.name(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<ProjectResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public ProjectResponseDto build() {
            return new ProjectResponseDto(this.id, this.name);
        }
    }
}
