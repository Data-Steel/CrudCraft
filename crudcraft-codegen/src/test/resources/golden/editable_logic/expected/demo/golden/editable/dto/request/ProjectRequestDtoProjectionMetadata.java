...
public final class ProjectRequestDtoProjectionMetadata implements ProjectionMetadata<ProjectRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null));

    @Override
    public Class<ProjectRequestDto> dtoType() {
        return ProjectRequestDto.class;
    }
