 ...
 */
package demo.golden.editable.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Project"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ProjectRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<ProjectRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<ProjectRef> fieldSecurityMetadata() {
