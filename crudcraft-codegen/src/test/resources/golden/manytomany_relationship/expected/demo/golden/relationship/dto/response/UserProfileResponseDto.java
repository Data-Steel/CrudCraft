 ...
 */
@Schema(
        description = "Response DTO for UserProfile"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record UserProfileResponseDto(@NotNull UUID id, @Nullable String displayName) {
    private static final FieldSecurityMetadata<UserProfileResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<UserProfileResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public UserProfileResponseDto build() {
            return new UserProfileResponseDto(this.id, this.displayName);
        }
    }
}
