 ...
 *
 * <p>Nullness: request DTO instances for AccessGroup are non-null. Fields may be null unless Jakarta validation marks them required; PATCH treats null according to mapper patch semantics, while PUT supplies replacement values.
 */
@Schema(
        description = "Create/update DTO for AccessGroup"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccessGroupRequestDto() {
    private static final FieldSecurityMetadata<AccessGroupRequestDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of());

    public static FieldSecurityMetadata<AccessGroupRequestDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        public AccessGroupRequestDto build() {
            return new AccessGroupRequestDto();
        }
    }
}
