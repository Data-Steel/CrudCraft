...
@Mapper(
        ...
        uses = {UserAccountMapper.class}
)
public interface AccessGroupMapper extends EntityMapper<AccessGroup, AccessGroupRequestDto, AccessGroupResponseDto, AccessGroupRef, UUID> {
    /**
     ...
     */
    @Override
    AccessGroup fromRequest(AccessGroupRequestDto request);
     ...
     */
    @Override
    AccessGroup update(@MappingTarget AccessGroup entity, AccessGroupRequestDto request);
    ...
    AccessGroup patch(@MappingTarget AccessGroup entity, AccessGroupRequestDto request);
     ...
     */
    @Override
    AccessGroupResponseDto toResponse(AccessGroup entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    AccessGroupRef toRef(AccessGroup entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(AccessGroupRequestDto request) {
        try {
