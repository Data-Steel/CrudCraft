 ...
 */
@Schema(
        description = "Reference DTO for UserAccount"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record UserAccountRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<UserAccountRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<UserAccountRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public UserAccountRef build() {
            return new UserAccountRef(this.id);
        }
    }
}
