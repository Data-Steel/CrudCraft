...
public final class UserAccountResponseDtoProjectionMetadata implements ProjectionMetadata<UserAccountResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("username","username",() -> null,false,null),new Attr("profile","profile",() -> null,false,null),new Attr("groups","groups",() -> null,true,null));

    @Override
    public Class<UserAccountResponseDto> dtoType() {
        return UserAccountResponseDto.class;
    }
