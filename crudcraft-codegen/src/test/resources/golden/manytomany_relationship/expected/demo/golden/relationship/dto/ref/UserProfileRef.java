package demo.golden.relationship.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for UserProfile"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record UserProfileRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<UserProfileRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<UserProfileRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public UserProfileRef build() {
            return new UserProfileRef(this.id);
        }
    }
}
