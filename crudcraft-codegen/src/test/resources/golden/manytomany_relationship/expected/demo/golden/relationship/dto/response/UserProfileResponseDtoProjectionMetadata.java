...
public final class UserProfileResponseDtoProjectionMetadata implements ProjectionMetadata<UserProfileResponseDto> {
    ...
    @Override
    public Class<UserProfileResponseDto> dtoType() {
        return UserProfileResponseDto.class;
    }
