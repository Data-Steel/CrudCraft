...
public final class AccessGroupResponseDtoProjectionMetadata implements ProjectionMetadata<AccessGroupResponseDto> {
    ...
    @Override
    public Class<AccessGroupResponseDto> dtoType() {
        return AccessGroupResponseDto.class;
    }
