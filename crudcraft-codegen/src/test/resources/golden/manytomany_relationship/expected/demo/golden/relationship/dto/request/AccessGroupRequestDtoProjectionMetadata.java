...
public final class AccessGroupRequestDtoProjectionMetadata implements ProjectionMetadata<AccessGroupRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<AccessGroupRequestDto> dtoType() {
        return AccessGroupRequestDto.class;
    }
