 ...
 */
@Schema(
        description = "Reference DTO for AccessGroup"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccessGroupRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<AccessGroupRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccessGroupRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccessGroupRef build() {
            return new AccessGroupRef(this.id);
        }
    }
}
