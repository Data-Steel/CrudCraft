...
public final class UserProfileRequestDtoProjectionMetadata implements ProjectionMetadata<UserProfileRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<UserProfileRequestDto> dtoType() {
        return UserProfileRequestDto.class;
    }
