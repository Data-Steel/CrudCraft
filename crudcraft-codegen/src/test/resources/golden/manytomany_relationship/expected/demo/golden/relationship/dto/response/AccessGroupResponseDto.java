 ...
 */
@Schema(
        description = "Response DTO for AccessGroup"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccessGroupResponseDto(@NotNull UUID id, @Nullable String name) {
    private static final FieldSecurityMetadata<AccessGroupResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("name", dto -> dto.name(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccessGroupResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccessGroupResponseDto build() {
            return new AccessGroupResponseDto(this.id, this.name);
        }
    }
}
