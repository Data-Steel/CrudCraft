...
public final class UserAccountRequestDtoProjectionMetadata implements ProjectionMetadata<UserAccountRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("username","username",() -> null,false,null),new Attr("profile","profile",() -> null,false,null),new Attr("groupIds","groupIds",() -> null,true,null));

    @Override
    public Class<UserAccountRequestDto> dtoType() {
        return UserAccountRequestDto.class;
    }
