...
public final class AuditLogResponseDtoProjectionMetadata implements ProjectionMetadata<AuditLogResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("actor","actor",() -> null,false,null),new Attr("happenedAt","happenedAt",() -> null,false,null));

    @Override
    public Class<AuditLogResponseDto> dtoType() {
        return AuditLogResponseDto.class;
    }
