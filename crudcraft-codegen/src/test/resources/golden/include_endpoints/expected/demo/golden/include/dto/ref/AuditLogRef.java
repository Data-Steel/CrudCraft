 ...
 */
package demo.golden.include.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for AuditLog"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AuditLogRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<AuditLogRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AuditLogRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AuditLogRef build() {
            return new AuditLogRef(this.id);
        }
    }
}
