 ...
 */
package demo.golden.include.dto.request;
 ...
 *
 * <p>Nullness: request DTO instances for AuditLog are non-null. Fields may be null unless Jakarta validation marks them required; PATCH treats null according to mapper patch semantics, while PUT supplies replacement values.
 */
@Schema(
        description = "Create/update DTO for AuditLog"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AuditLogRequestDto() {
    private static final FieldSecurityMetadata<AuditLogRequestDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of());

    public static FieldSecurityMetadata<AuditLogRequestDto> fieldSecurityMetadata() {
