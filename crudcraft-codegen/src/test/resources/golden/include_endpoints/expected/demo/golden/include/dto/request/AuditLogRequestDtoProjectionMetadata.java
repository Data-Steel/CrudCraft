...
public final class AuditLogRequestDtoProjectionMetadata implements ProjectionMetadata<AuditLogRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<AuditLogRequestDto> dtoType() {
        return AuditLogRequestDto.class;
    }
