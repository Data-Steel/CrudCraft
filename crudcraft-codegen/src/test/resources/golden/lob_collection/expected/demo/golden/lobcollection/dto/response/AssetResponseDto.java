 ...
 */
@Schema(
        description = "Response DTO for Asset"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AssetResponseDto(@NotNull UUID id, @Nullable String name,
        @Nullable Set<byte[]> attachments) {
    private static final FieldSecurityMetadata<AssetResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<AssetResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AssetResponseDto build() {
            return new AssetResponseDto(this.id, this.name, this.attachments);
        }
    }
}
