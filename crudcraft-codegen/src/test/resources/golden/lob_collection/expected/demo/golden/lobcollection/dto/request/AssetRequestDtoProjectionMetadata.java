...
public final class AssetRequestDtoProjectionMetadata implements ProjectionMetadata<AssetRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null),new Attr("attachments","attachments",() -> null,true,null));

    @Override
    public Class<AssetRequestDto> dtoType() {
