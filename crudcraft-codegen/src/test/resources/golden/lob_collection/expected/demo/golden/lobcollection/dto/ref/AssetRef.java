 ...
 */
package demo.golden.lobcollection.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Asset"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AssetRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<AssetRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AssetRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AssetRef build() {
            return new AssetRef(this.id);
        }
    }
}
