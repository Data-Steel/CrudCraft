...
public final class LookupRequestDtoProjectionMetadata implements ProjectionMetadata<LookupRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<LookupRequestDto> dtoType() {
        return LookupRequestDto.class;
    }
