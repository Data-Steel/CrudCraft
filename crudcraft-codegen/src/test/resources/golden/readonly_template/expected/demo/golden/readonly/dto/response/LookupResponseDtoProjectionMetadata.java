...
public final class LookupResponseDtoProjectionMetadata implements ProjectionMetadata<LookupResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("code","code",() -> null,false,null),new Attr("label","label",() -> null,false,null));

    @Override
    public Class<LookupResponseDto> dtoType() {
        return LookupResponseDto.class;
    }
