 ...
 */
package demo.golden.readonly.projection;

import demo.golden.readonly.dto.request.LookupRequestDtoProjectionMetadata;
import demo.golden.readonly.dto.response.LookupResponseDtoProjectionMetadata;
...
public class GeneratedProjectionMetadataRegistry implements ProjectionMetadataRegistry {
    ...
    public GeneratedProjectionMetadataRegistry() {
        register(new LookupRequestDtoProjectionMetadata());
        register(new LookupResponseDtoProjectionMetadata());
    }
