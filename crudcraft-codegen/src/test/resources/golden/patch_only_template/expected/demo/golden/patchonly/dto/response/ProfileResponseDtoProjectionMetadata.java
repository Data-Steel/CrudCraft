...
public final class ProfileResponseDtoProjectionMetadata implements ProjectionMetadata<ProfileResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("displayName","displayName",() -> null,false,null),new Attr("bio","bio",() -> null,false,null));

    @Override
    public Class<ProfileResponseDto> dtoType() {
