package demo.golden.patchonly.projection;

import demo.golden.patchonly.dto.request.ProfileRequestDtoProjectionMetadata;
import demo.golden.patchonly.dto.response.ProfileResponseDtoProjectionMetadata;
...
public class GeneratedProjectionMetadataRegistry implements ProjectionMetadataRegistry {
    ...
    public GeneratedProjectionMetadataRegistry() {
        register(new ProfileRequestDtoProjectionMetadata());
        register(new ProfileResponseDtoProjectionMetadata());
    }
