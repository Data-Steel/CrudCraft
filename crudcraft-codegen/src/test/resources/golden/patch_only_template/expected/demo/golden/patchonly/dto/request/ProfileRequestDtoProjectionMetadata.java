...
public final class ProfileRequestDtoProjectionMetadata implements ProjectionMetadata<ProfileRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("displayName","displayName",() -> null,false,null),new Attr("bio","bio",() -> null,false,null));

    @Override
    public Class<ProfileRequestDto> dtoType() {
        return ProfileRequestDto.class;
    }
