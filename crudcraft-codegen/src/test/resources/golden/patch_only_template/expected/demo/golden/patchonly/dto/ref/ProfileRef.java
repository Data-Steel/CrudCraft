package demo.golden.patchonly.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Profile"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ProfileRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<ProfileRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<ProfileRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public ProfileRef build() {
            return new ProfileRef(this.id);
        }
    }
}
