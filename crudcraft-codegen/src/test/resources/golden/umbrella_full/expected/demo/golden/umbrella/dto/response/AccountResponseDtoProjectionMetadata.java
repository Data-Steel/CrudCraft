...
public final class AccountResponseDtoProjectionMetadata implements ProjectionMetadata<AccountResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("tenantId","tenantId",() -> null,false,null),new Attr("ownerId","ownerId",() -> null,false,null),new Attr("type","type",() -> null,false,null),new Attr("createdAt","createdAt",() -> null,false,null),new Attr("secret","secret",() -> null,false,null),new Attr("profile","profile",() -> null,false,null),new Attr("tags","tags",() -> null,true,null),new Attr("logo","logo",() -> null,false,null));

    @Override
    public Class<AccountResponseDto> dtoType() {
