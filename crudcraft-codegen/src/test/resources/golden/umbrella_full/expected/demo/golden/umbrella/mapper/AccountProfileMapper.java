...
public interface AccountProfileMapper extends EntityMapper<AccountProfile, AccountProfileRequestDto, AccountProfileResponseDto, AccountProfileRef, UUID> {
    /**
     ...
     */
    @Override
    AccountProfile fromRequest(AccountProfileRequestDto request);
     ...
     */
    @Override
    AccountProfile update(@MappingTarget AccountProfile entity, AccountProfileRequestDto request);
    ...
    AccountProfile patch(@MappingTarget AccountProfile entity, AccountProfileRequestDto request);
     ...
     */
    @Override
    AccountProfileResponseDto toResponse(AccountProfile entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    AccountProfileRef toRef(AccountProfile entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(AccountProfileRequestDto request) {
        try {
