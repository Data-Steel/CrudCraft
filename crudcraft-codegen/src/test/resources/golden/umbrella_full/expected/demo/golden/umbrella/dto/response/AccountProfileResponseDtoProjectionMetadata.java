...
public final class AccountProfileResponseDtoProjectionMetadata implements ProjectionMetadata<AccountProfileResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("displayName","displayName",() -> null,false,null));

    @Override
    public Class<AccountProfileResponseDto> dtoType() {
        return AccountProfileResponseDto.class;
    }
