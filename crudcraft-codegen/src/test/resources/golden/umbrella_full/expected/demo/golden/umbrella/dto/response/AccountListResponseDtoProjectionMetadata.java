...
public final class AccountListResponseDtoProjectionMetadata implements ProjectionMetadata<AccountListResponseDto> {
    ...
    @Override
    public Class<AccountListResponseDto> dtoType() {
        return AccountListResponseDto.class;
    }
