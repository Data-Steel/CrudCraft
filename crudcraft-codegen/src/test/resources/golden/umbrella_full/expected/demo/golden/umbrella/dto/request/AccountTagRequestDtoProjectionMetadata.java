...
public final class AccountTagRequestDtoProjectionMetadata implements ProjectionMetadata<AccountTagRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<AccountTagRequestDto> dtoType() {
        return AccountTagRequestDto.class;
    }
