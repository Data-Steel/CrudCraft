...
public final class AccountTagResponseDtoProjectionMetadata implements ProjectionMetadata<AccountTagResponseDto> {
    ...
    @Override
    public Class<AccountTagResponseDto> dtoType() {
        return AccountTagResponseDto.class;
    }
