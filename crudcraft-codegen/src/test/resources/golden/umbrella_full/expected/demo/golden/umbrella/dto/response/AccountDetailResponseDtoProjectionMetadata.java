...
public final class AccountDetailResponseDtoProjectionMetadata implements ProjectionMetadata<AccountDetailResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("tenantId","tenantId",() -> null,false,null));

    @Override
    public Class<AccountDetailResponseDto> dtoType() {
        return AccountDetailResponseDto.class;
    }
