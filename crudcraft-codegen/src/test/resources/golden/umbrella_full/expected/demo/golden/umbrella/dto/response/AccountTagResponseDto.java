 ...
 */
@Schema(
        description = "Response DTO for AccountTag"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountTagResponseDto(@NotNull UUID id, @Nullable String label) {
    private static final FieldSecurityMetadata<AccountTagResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("label", dto -> dto.label(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccountTagResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccountTagResponseDto build() {
            return new AccountTagResponseDto(this.id, this.label);
        }
    }
}
