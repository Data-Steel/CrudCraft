 ...
 */
public final class AccountTagRelationshipMeta {
    private AccountTagRelationshipMeta() {
    }

    public static void fix(AccountTag entity) {
        // no bidirectional relationships to fix;
    }

    public static void clear(AccountTag entity) {
