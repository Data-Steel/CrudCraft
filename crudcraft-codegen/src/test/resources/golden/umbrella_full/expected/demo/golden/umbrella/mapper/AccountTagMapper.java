...
public interface AccountTagMapper extends EntityMapper<AccountTag, AccountTagRequestDto, AccountTagResponseDto, AccountTagRef, UUID> {
    /**
     ...
     */
    @Override
    AccountTag fromRequest(AccountTagRequestDto request);
     ...
     */
    @Override
    AccountTag update(@MappingTarget AccountTag entity, AccountTagRequestDto request);
    ...
    AccountTag patch(@MappingTarget AccountTag entity, AccountTagRequestDto request);
     ...
     */
    @Override
    AccountTagResponseDto toResponse(AccountTag entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    AccountTagRef toRef(AccountTag entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(AccountTagRequestDto request) {
        try {
