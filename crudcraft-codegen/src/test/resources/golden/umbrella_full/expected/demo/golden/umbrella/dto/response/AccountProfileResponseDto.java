 ...
 */
@Schema(
        description = "Response DTO for AccountProfile"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountProfileResponseDto(@NotNull UUID id, @Nullable String displayName) {
    private static final FieldSecurityMetadata<AccountProfileResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<AccountProfileResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccountProfileResponseDto build() {
            return new AccountProfileResponseDto(this.id, this.displayName);
        }
    }
}
