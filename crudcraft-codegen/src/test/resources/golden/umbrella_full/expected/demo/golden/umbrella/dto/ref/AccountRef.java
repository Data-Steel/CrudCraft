 ...
 */
@Schema(
        description = "Reference DTO for Account"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<AccountRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccountRef> fieldSecurityMetadata() {
