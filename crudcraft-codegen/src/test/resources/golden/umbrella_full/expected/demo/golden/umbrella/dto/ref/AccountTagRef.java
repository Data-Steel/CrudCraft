 ...
 */
@Schema(
        description = "Reference DTO for AccountTag"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountTagRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<AccountTagRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccountTagRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccountTagRef build() {
            return new AccountTagRef(this.id);
        }
    }
}
