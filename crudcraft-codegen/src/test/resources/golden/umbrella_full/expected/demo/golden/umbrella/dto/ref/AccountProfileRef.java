package demo.golden.umbrella.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for AccountProfile"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountProfileRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<AccountProfileRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccountProfileRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccountProfileRef build() {
            return new AccountProfileRef(this.id);
        }
    }
}
