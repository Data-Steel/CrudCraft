...
public final class AccountProfileRequestDtoProjectionMetadata implements ProjectionMetadata<AccountProfileRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<AccountProfileRequestDto> dtoType() {
        return AccountProfileRequestDto.class;
    }
