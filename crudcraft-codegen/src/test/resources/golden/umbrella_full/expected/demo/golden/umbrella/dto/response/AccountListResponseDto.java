 ...
 */
@Schema(
        description = "Response DTO List for Account"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountListResponseDto(@NotNull UUID id, @Nullable @NotBlank String name) {
    private static final FieldSecurityMetadata<AccountListResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("name", dto -> dto.name(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<AccountListResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public AccountListResponseDto build() {
            return new AccountListResponseDto(this.id, this.name);
        }
    }
}
