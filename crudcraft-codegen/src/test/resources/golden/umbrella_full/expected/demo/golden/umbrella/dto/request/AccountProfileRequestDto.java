 ...
 *
 * <p>Nullness: request DTO instances for AccountProfile are non-null. Fields may be null unless Jakarta validation marks them required; PATCH treats null according to mapper patch semantics, while PUT supplies replacement values.
 */
@Schema(
        description = "Create/update DTO for AccountProfile"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AccountProfileRequestDto() {
    private static final FieldSecurityMetadata<AccountProfileRequestDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of());

    public static FieldSecurityMetadata<AccountProfileRequestDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        public AccountProfileRequestDto build() {
