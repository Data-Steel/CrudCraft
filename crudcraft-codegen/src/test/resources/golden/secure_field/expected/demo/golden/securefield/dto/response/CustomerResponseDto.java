package demo.golden.securefield.dto.response;
 ...
 */
@Schema(
        description = "Response DTO for Customer"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CustomerResponseDto(@NotNull UUID id, @Nullable String name,
    ...
    private static final FieldSecurityMetadata<CustomerResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    ...
    public static FieldSecurityMetadata<CustomerResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CustomerResponseDto build() {
            return new CustomerResponseDto(this.id, this.name, this.loyaltyPoints, this.vip);
        }
    }
}
