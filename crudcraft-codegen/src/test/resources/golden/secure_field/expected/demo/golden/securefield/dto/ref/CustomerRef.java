 ...
 */
package demo.golden.securefield.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Customer"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CustomerRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<CustomerRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CustomerRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CustomerRef build() {
            return new CustomerRef(this.id);
        }
    }
}
