package demo.golden.securefield.meta;
 ...
 */
public final class CustomerRelationshipMeta {
    private CustomerRelationshipMeta() {
    }

    public static void fix(Customer entity) {
        if (entity == null) {
    ...
    public static void clear(Customer entity) {
        if (entity == null) {
            throw new IllegalArgumentException("entity");
        }
