...
public final class CustomerRequestDtoProjectionMetadata implements ProjectionMetadata<CustomerRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null),new Attr("loyaltyPoints","loyaltyPoints",() -> null,false,null),new Attr("vip","vip",() -> null,false,null));

    @Override
    public Class<CustomerRequestDto> dtoType() {
