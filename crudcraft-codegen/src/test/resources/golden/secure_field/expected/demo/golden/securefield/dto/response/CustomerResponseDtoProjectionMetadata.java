...
public final class CustomerResponseDtoProjectionMetadata implements ProjectionMetadata<CustomerResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("loyaltyPoints","loyaltyPoints",() -> null,false,null),new Attr("vip","vip",() -> null,false,null));

    @Override
    public Class<CustomerResponseDto> dtoType() {
