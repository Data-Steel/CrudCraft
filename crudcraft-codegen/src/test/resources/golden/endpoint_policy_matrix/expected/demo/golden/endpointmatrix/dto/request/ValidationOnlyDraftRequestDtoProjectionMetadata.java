...
public final class ValidationOnlyDraftRequestDtoProjectionMetadata implements ProjectionMetadata<ValidationOnlyDraftRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("content","content",() -> null,false,null));

    @Override
    public Class<ValidationOnlyDraftRequestDto> dtoType() {
        return ValidationOnlyDraftRequestDto.class;
    }
