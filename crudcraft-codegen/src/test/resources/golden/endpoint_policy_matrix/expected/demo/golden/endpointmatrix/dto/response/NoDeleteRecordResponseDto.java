 ...
 */
@Schema(
        description = "Response DTO for NoDeleteRecord"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record NoDeleteRecordResponseDto(@NotNull UUID id, @Nullable String title) {
    private static final FieldSecurityMetadata<NoDeleteRecordResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("title", dto -> dto.title(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<NoDeleteRecordResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public NoDeleteRecordResponseDto build() {
            return new NoDeleteRecordResponseDto(this.id, this.title);
        }
    }
}
