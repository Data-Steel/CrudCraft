...
public final class CustomPolicyReportRequestDtoProjectionMetadata implements ProjectionMetadata<CustomPolicyReportRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null));

    @Override
    public Class<CustomPolicyReportRequestDto> dtoType() {
        return CustomPolicyReportRequestDto.class;
    }
