...
public final class NoDeleteRecordRequestDtoProjectionMetadata implements ProjectionMetadata<NoDeleteRecordRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("title","title",() -> null,false,null));

    @Override
    public Class<NoDeleteRecordRequestDto> dtoType() {
        return NoDeleteRecordRequestDto.class;
    }
