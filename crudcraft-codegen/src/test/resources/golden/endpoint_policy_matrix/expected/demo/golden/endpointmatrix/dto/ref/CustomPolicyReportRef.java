 ...
 */
@Schema(
        description = "Reference DTO for CustomPolicyReport"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CustomPolicyReportRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<CustomPolicyReportRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CustomPolicyReportRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CustomPolicyReportRef build() {
            return new CustomPolicyReportRef(this.id);
        }
    }
}
