...
public final class LightPublicPageResponseDtoProjectionMetadata implements ProjectionMetadata<LightPublicPageResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("label","label",() -> null,false,null));

    @Override
    public Class<LightPublicPageResponseDto> dtoType() {
        return LightPublicPageResponseDto.class;
    }
