...
public final class SecureInternalSecretResponseDtoProjectionMetadata implements ProjectionMetadata<SecureInternalSecretResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("secret","secret",() -> null,false,null));

    @Override
    public Class<SecureInternalSecretResponseDto> dtoType() {
        return SecureInternalSecretResponseDto.class;
    }
