 ...
 */
@Schema(
        description = "Reference DTO for LightPublicPage"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record LightPublicPageRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<LightPublicPageRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<LightPublicPageRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public LightPublicPageRef build() {
            return new LightPublicPageRef(this.id);
        }
    }
}
