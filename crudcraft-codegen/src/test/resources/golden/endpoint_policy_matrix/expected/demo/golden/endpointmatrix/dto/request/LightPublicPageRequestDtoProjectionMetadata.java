...
public final class LightPublicPageRequestDtoProjectionMetadata implements ProjectionMetadata<LightPublicPageRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<LightPublicPageRequestDto> dtoType() {
        return LightPublicPageRequestDto.class;
    }
