 ...
 */
@Schema(
        description = "Response DTO for CreateOnlyTask"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CreateOnlyTaskResponseDto(@NotNull UUID id, @Nullable String name) {
    private static final FieldSecurityMetadata<CreateOnlyTaskResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("name", dto -> dto.name(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CreateOnlyTaskResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CreateOnlyTaskResponseDto build() {
            return new CreateOnlyTaskResponseDto(this.id, this.name);
        }
    }
}
