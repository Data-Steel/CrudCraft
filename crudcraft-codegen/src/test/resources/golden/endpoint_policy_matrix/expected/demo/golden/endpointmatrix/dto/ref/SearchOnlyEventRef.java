 ...
 */
@Schema(
        description = "Reference DTO for SearchOnlyEvent"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SearchOnlyEventRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<SearchOnlyEventRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SearchOnlyEventRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public SearchOnlyEventRef build() {
            return new SearchOnlyEventRef(this.id);
        }
    }
}
