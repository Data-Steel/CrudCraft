 ...
 */
@Schema(
        description = "Response DTO for SecureInternalSecret"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SecureInternalSecretResponseDto(@NotNull UUID id, @Nullable String secret) {
    private static final FieldSecurityMetadata<SecureInternalSecretResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("secret", dto -> dto.secret(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SecureInternalSecretResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public SecureInternalSecretResponseDto build() {
            return new SecureInternalSecretResponseDto(this.id, this.secret);
        }
    }
}
