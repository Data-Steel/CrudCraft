 ...
 */
@Schema(
        description = "Reference DTO for NoDeleteRecord"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record NoDeleteRecordRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<NoDeleteRecordRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<NoDeleteRecordRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public NoDeleteRecordRef build() {
            return new NoDeleteRecordRef(this.id);
        }
    }
}
