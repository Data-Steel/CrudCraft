 ...
 */
@Schema(
        description = "Response DTO for CustomPolicyReport"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CustomPolicyReportResponseDto(@NotNull UUID id, @Nullable String name) {
    private static final FieldSecurityMetadata<CustomPolicyReportResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("name", dto -> dto.name(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CustomPolicyReportResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CustomPolicyReportResponseDto build() {
            return new CustomPolicyReportResponseDto(this.id, this.name);
        }
    }
}
