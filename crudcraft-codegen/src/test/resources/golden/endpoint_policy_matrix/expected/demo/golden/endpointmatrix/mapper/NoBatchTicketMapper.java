...
public interface NoBatchTicketMapper extends EntityMapper<NoBatchTicket, NoBatchTicketRequestDto, NoBatchTicketResponseDto, NoBatchTicketRef, UUID> {
    /**
     ...
     */
    @Override
    NoBatchTicket fromRequest(NoBatchTicketRequestDto request);
     ...
     */
    @Override
    NoBatchTicket update(@MappingTarget NoBatchTicket entity, NoBatchTicketRequestDto request);
    ...
    NoBatchTicket patch(@MappingTarget NoBatchTicket entity, NoBatchTicketRequestDto request);
     ...
     */
    @Override
    NoBatchTicketResponseDto toResponse(NoBatchTicket entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    NoBatchTicketRef toRef(NoBatchTicket entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(NoBatchTicketRequestDto request) {
        try {
