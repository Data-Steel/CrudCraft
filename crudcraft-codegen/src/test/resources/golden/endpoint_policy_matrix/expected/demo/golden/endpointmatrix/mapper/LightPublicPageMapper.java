...
public interface LightPublicPageMapper extends EntityMapper<LightPublicPage, LightPublicPageRequestDto, LightPublicPageResponseDto, LightPublicPageRef, UUID> {
    /**
     ...
     */
    @Override
    LightPublicPage fromRequest(LightPublicPageRequestDto request);
     ...
     */
    @Override
    LightPublicPage update(@MappingTarget LightPublicPage entity,
            LightPublicPageRequestDto request);
    ...
    LightPublicPage patch(@MappingTarget LightPublicPage entity, LightPublicPageRequestDto request);
     ...
     */
    @Override
    LightPublicPageResponseDto toResponse(LightPublicPage entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    LightPublicPageRef toRef(LightPublicPage entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(LightPublicPageRequestDto request) {
        try {
