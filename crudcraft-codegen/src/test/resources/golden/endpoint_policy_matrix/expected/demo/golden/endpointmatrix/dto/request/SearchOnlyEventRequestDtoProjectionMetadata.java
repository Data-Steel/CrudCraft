...
public final class SearchOnlyEventRequestDtoProjectionMetadata implements ProjectionMetadata<SearchOnlyEventRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of();

    @Override
    public Class<SearchOnlyEventRequestDto> dtoType() {
        return SearchOnlyEventRequestDto.class;
    }
