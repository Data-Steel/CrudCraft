 ...
 */
@Schema(
        description = "Reference DTO for NoBatchTicket"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record NoBatchTicketRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<NoBatchTicketRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<NoBatchTicketRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public NoBatchTicketRef build() {
            return new NoBatchTicketRef(this.id);
        }
    }
}
