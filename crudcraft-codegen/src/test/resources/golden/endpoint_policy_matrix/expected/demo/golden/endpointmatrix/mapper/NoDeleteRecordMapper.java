...
public interface NoDeleteRecordMapper extends EntityMapper<NoDeleteRecord, NoDeleteRecordRequestDto, NoDeleteRecordResponseDto, NoDeleteRecordRef, UUID> {
    /**
     ...
     */
    @Override
    NoDeleteRecord fromRequest(NoDeleteRecordRequestDto request);
     ...
     */
    @Override
    NoDeleteRecord update(@MappingTarget NoDeleteRecord entity, NoDeleteRecordRequestDto request);
    ...
    NoDeleteRecord patch(@MappingTarget NoDeleteRecord entity, NoDeleteRecordRequestDto request);
     ...
     */
    @Override
    NoDeleteRecordResponseDto toResponse(NoDeleteRecord entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    NoDeleteRecordRef toRef(NoDeleteRecord entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(NoDeleteRecordRequestDto request) {
        try {
