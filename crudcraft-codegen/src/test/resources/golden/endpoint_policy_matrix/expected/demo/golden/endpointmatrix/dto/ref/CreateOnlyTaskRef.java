 ...
 */
@Schema(
        description = "Reference DTO for CreateOnlyTask"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CreateOnlyTaskRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<CreateOnlyTaskRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<CreateOnlyTaskRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public CreateOnlyTaskRef build() {
            return new CreateOnlyTaskRef(this.id);
        }
    }
}
