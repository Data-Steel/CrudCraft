...
public final class CustomPolicyReportResponseDtoProjectionMetadata implements ProjectionMetadata<CustomPolicyReportResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null));

    @Override
    public Class<CustomPolicyReportResponseDto> dtoType() {
        return CustomPolicyReportResponseDto.class;
    }
