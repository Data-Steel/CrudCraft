...
public interface CustomPolicyReportMapper extends EntityMapper<CustomPolicyReport, CustomPolicyReportRequestDto, CustomPolicyReportResponseDto, CustomPolicyReportRef, UUID> {
    /**
     ...
     */
    @Override
    CustomPolicyReport fromRequest(CustomPolicyReportRequestDto request);
     ...
     */
    @Override
    CustomPolicyReport update(@MappingTarget CustomPolicyReport entity,
            CustomPolicyReportRequestDto request);
    ...
    CustomPolicyReport patch(@MappingTarget CustomPolicyReport entity,
            CustomPolicyReportRequestDto request);
     ...
     */
    @Override
    CustomPolicyReportResponseDto toResponse(CustomPolicyReport entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    CustomPolicyReportRef toRef(CustomPolicyReport entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(CustomPolicyReportRequestDto request) {
        try {
