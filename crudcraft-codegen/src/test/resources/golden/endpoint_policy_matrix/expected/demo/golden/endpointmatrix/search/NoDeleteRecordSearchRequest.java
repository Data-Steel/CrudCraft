...
public class NoDeleteRecordSearchRequest implements SearchRequest<NoDeleteRecord>, Serializable {
    ...
    public NoDeleteRecordSearchRequest() {
    }

    public NoDeleteRecordSearchRequest(NoDeleteRecordSearchRequest other) {
        if (other != null) {
    ...
    @Override
    public Specification<NoDeleteRecord> toSpecification() {
        validate();
        return new NoDeleteRecordSpecification(this);
    }
}
