...
public final class NoDeleteRecordResponseDtoProjectionMetadata implements ProjectionMetadata<NoDeleteRecordResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("title","title",() -> null,false,null));

    @Override
    public Class<NoDeleteRecordResponseDto> dtoType() {
        return NoDeleteRecordResponseDto.class;
    }
