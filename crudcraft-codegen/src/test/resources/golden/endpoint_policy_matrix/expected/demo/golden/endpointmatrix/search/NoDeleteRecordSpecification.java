 ...
 *
 * Example:
 * var request = new NoDeleteRecordSearchRequest();
 ...
 */
public class NoDeleteRecordSpecification implements Specification<NoDeleteRecord> {
    private static final long serialVersionUID = 1L;

    private final NoDeleteRecordSearchRequest request;

    public NoDeleteRecordSpecification(NoDeleteRecordSearchRequest request) {
        this.request = new NoDeleteRecordSearchRequest(request);
    }

    @Override
    public Predicate toPredicate(Root<NoDeleteRecord> root, CriteriaQuery<?> query,
            CriteriaBuilder cb) {
