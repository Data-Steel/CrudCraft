...
public final class CreateOnlyTaskRequestDtoProjectionMetadata implements ProjectionMetadata<CreateOnlyTaskRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null));

    @Override
    public Class<CreateOnlyTaskRequestDto> dtoType() {
        return CreateOnlyTaskRequestDto.class;
    }
