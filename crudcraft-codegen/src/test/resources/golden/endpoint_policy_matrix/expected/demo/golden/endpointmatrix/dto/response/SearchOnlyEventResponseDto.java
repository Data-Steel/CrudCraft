 ...
 * @param message message - nullable unless copied validation annotations require a value or constrain its range.
 */
@Schema(
        description = "Response DTO for SearchOnlyEvent"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SearchOnlyEventResponseDto(@NotNull UUID id, @Nullable String message) {
    private static final FieldSecurityMetadata<SearchOnlyEventResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("message", dto -> dto.message(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SearchOnlyEventResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public SearchOnlyEventResponseDto build() {
            return new SearchOnlyEventResponseDto(this.id, this.message);
        }
    }
}
