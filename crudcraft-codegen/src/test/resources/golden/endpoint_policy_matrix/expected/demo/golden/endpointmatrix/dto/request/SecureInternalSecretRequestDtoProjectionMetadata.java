...
public final class SecureInternalSecretRequestDtoProjectionMetadata implements ProjectionMetadata<SecureInternalSecretRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("secret","secret",() -> null,false,null));

    @Override
    public Class<SecureInternalSecretRequestDto> dtoType() {
        return SecureInternalSecretRequestDto.class;
    }
