 ...
 */
@Schema(
        description = "Reference DTO for SecureInternalSecret"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SecureInternalSecretRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<SecureInternalSecretRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SecureInternalSecretRef> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public SecureInternalSecretRef build() {
            return new SecureInternalSecretRef(this.id);
        }
    }
}
