...
public final class NoBatchTicketRequestDtoProjectionMetadata implements ProjectionMetadata<NoBatchTicketRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("subject","subject",() -> null,false,null));

    @Override
    public Class<NoBatchTicketRequestDto> dtoType() {
        return NoBatchTicketRequestDto.class;
    }
