...
public final class SearchOnlyEventResponseDtoProjectionMetadata implements ProjectionMetadata<SearchOnlyEventResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("message","message",() -> null,false,null));

    @Override
    public Class<SearchOnlyEventResponseDto> dtoType() {
        return SearchOnlyEventResponseDto.class;
    }
