...
public final class CreateOnlyTaskResponseDtoProjectionMetadata implements ProjectionMetadata<CreateOnlyTaskResponseDto> {
    ...
    @Override
    public Class<CreateOnlyTaskResponseDto> dtoType() {
        return CreateOnlyTaskResponseDto.class;
    }
