 ...
 */
@Schema(
        description = "Response DTO for ValidationOnlyDraft"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ValidationOnlyDraftResponseDto(@NotNull UUID id, @Nullable @NotBlank String content) {
    private static final FieldSecurityMetadata<ValidationOnlyDraftResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("content", dto -> dto.content(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<ValidationOnlyDraftResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public ValidationOnlyDraftResponseDto build() {
            return new ValidationOnlyDraftResponseDto(this.id, this.content);
        }
    }
}
