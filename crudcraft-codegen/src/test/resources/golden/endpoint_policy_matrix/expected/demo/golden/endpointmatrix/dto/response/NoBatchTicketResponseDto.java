 ...
 */
@Schema(
        description = "Response DTO for NoBatchTicket"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record NoBatchTicketResponseDto(@NotNull UUID id, @Nullable String subject) {
    private static final FieldSecurityMetadata<NoBatchTicketResponseDto> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED),
    new FieldSecurityMetadata.FieldRule<>("subject", dto -> dto.subject(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<NoBatchTicketResponseDto> fieldSecurityMetadata() {
    ...
    public static class Builder {
        ...
        public NoBatchTicketResponseDto build() {
            return new NoBatchTicketResponseDto(this.id, this.subject);
        }
    }
}
