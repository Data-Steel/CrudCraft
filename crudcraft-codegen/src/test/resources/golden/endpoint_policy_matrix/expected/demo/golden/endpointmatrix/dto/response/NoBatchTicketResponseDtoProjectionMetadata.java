...
public final class NoBatchTicketResponseDtoProjectionMetadata implements ProjectionMetadata<NoBatchTicketResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("subject","subject",() -> null,false,null));

    @Override
    public Class<NoBatchTicketResponseDto> dtoType() {
        return NoBatchTicketResponseDto.class;
    }
