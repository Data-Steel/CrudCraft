...
public interface ValidationOnlyDraftMapper extends EntityMapper<ValidationOnlyDraft, ValidationOnlyDraftRequestDto, ValidationOnlyDraftResponseDto, ValidationOnlyDraftRef, UUID> {
    /**
     ...
     */
    @Override
    ValidationOnlyDraft fromRequest(ValidationOnlyDraftRequestDto request);
     ...
     */
    @Override
    ValidationOnlyDraft update(@MappingTarget ValidationOnlyDraft entity,
            ValidationOnlyDraftRequestDto request);
    ...
    ValidationOnlyDraft patch(@MappingTarget ValidationOnlyDraft entity,
            ValidationOnlyDraftRequestDto request);
     ...
     */
    @Override
    ValidationOnlyDraftResponseDto toResponse(ValidationOnlyDraft entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    ValidationOnlyDraftRef toRef(ValidationOnlyDraft entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(ValidationOnlyDraftRequestDto request) {
        try {
