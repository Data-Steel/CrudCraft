...
public final class ValidationOnlyDraftResponseDtoProjectionMetadata implements ProjectionMetadata<ValidationOnlyDraftResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("content","content",() -> null,false,null));

    @Override
    public Class<ValidationOnlyDraftResponseDto> dtoType() {
        return ValidationOnlyDraftResponseDto.class;
    }
