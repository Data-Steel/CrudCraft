...
package demo.golden.endpointmatrix;
...
@Entity
@CrudCrafted(
        template = CrudTemplate.SECURE_INTERNAL,
        secure = true,
        securityPolicy = MatrixSecurityPolicy.class)
public class SecureInternalSecret {
    @Id @Dto(ref = true) private UUID id;
    @Dto @Request private String secret;
}
