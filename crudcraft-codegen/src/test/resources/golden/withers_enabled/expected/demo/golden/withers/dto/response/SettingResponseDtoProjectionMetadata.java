...
public final class SettingResponseDtoProjectionMetadata implements ProjectionMetadata<SettingResponseDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("id","id",() -> null,false,null),new Attr("name","name",() -> null,false,null),new Attr("value","value",() -> null,false,null));

    @Override
    public Class<SettingResponseDto> dtoType() {
        return SettingResponseDto.class;
    }
