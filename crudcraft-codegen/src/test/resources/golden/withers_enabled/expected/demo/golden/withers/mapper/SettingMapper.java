package demo.golden.withers.mapper;
...
public interface SettingMapper extends EntityMapper<Setting, SettingRequestDto, SettingResponseDto, SettingRef, UUID> {
    /**
     ...
     */
    @Override
    Setting fromRequest(SettingRequestDto request);
     ...
     */
    @Override
    Setting update(@MappingTarget Setting entity, SettingRequestDto request);
    ...
    Setting patch(@MappingTarget Setting entity, SettingRequestDto request);
     ...
     */
    @Override
    SettingResponseDto toResponse(Setting entity);

    /**
     * Maps an entity to its lightweight reference DTO.
     */
    @Override
    SettingRef toRef(Setting entity);
     ...
     */
    @Override
    default UUID getIdFromRequest(SettingRequestDto request) {
        try {
