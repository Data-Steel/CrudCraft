 ...
 */
package demo.golden.withers.dto.ref;
 ...
 */
@Schema(
        description = "Reference DTO for Setting"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SettingRef(@NotNull UUID id) {
    private static final FieldSecurityMetadata<SettingRef> FIELD_SECURITY_METADATA = FieldSecurityMetadata.of(List.of(new FieldSecurityMetadata.FieldRule<>("id", dto -> dto.id(), null, false, List.of(), List.of(), WritePolicy.SKIP_ON_DENIED)));

    public static FieldSecurityMetadata<SettingRef> fieldSecurityMetadata() {
        return FIELD_SECURITY_METADATA;
    }

    public SettingRef withId(@NotNull UUID id) {
        return new SettingRef(id);
    }
    ...
    public static class Builder {
        ...
        public SettingRef build() {
            return new SettingRef(this.id);
        }
    }
}
