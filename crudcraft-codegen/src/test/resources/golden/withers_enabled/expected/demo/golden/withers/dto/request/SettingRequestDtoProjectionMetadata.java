...
public final class SettingRequestDtoProjectionMetadata implements ProjectionMetadata<SettingRequestDto> {
    private static final List<ProjectionMetadata.Attribute> ATTRIBUTES = List.of(new Attr("name","name",() -> null,false,null),new Attr("value","value",() -> null,false,null));

    @Override
    public Class<SettingRequestDto> dtoType() {
        return SettingRequestDto.class;
    }
