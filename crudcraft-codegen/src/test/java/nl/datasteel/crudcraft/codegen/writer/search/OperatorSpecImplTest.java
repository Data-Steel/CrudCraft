...
class OperatorSpecImplTest {
    ...
    void valueOperatorPreservesCollectionTypes() {
        ...
        assertTrue(
                code.contains("java.util.Set<nl.datasteel.test.TagSearchRequest> tags"),
    ...
    void valueOperatorUsesScalarTypes() {
        ...
        assertTrue(
                code.contains("private java.lang.String name"),
                "Simple types should be scalar (not wrapped in Set) to comply with RFC 7230/3986,"
                        + " but got: "
                        + code);
        assertTrue(
                code.contains("public java.lang.String getName()"), "Getter should return String");
        assertTrue(
                code.contains("public void setName(java.lang.String name)"),
