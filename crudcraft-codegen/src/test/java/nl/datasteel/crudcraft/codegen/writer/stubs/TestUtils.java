...
class TestUtils {
    ...
    static class RecordingJavaFileObject extends SimpleJavaFileObject {
        private static final class CapturingWriter extends StringWriter {
            private final RecordingJavaFileObject owner;

            private CapturingWriter(RecordingJavaFileObject owner) {
                this.owner = owner;
            }

            @Override
            public void close() throws IOException {
                owner.written = toString();
                super.close();
            }
        }
    ...
    static class ProcessingEnvStub implements ProcessingEnvironment {
        ...
        public Elements getElementUtils() {
            return new ElementsStub();
        }

        @Override
        public Types getTypeUtils() {
            return new TypesStub();
        }
    ...
    static class RecordingWriteContext extends WriteContext {
        ...
        RecordingWriteContext(ProcessingEnvironment env) {
            super(env);
        }
