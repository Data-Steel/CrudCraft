...
class SearchAccessorUtilTest {
    ...
    void privateConstructorIsCoveredForStrictMutationLineCoverage() throws Exception {
        var constructor = SearchAccessorUtil.class.getDeclaredConstructor();
    ...
    void getterReturnsFieldDirectlyForSimpleType() {
        ...
        assertTrue(!code.contains("List.copyOf"));
        assertTrue(!code.contains("Set.copyOf"));
    }
    ...
    /**
     * Utility to convert a MethodSpec to string representation of a full class, so we can inspect
     * the generated method code in context.
     *
