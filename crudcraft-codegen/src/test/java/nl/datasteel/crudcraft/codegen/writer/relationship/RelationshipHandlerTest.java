...
class RelationshipHandlerTest {
    ...
    private static final class NoOpRelationshipHandler implements RelationshipHandler {
        @Override
        public void addFix(
                ModelDescriptor md,
                FieldDescriptor fd,
                com.palantir.javapoet.MethodSpec.Builder fix,
                com.palantir.javapoet.ClassName entityType) {}

        @Override
        public void addClear(
                ModelDescriptor md,
                FieldDescriptor fd,
                com.palantir.javapoet.MethodSpec.Builder clear,
                com.palantir.javapoet.ClassName entityType) {}
    }
    ...
    @BeforeEach
    void setUp() {
        handler = new NoOpRelationshipHandler();
    ...
    void relationshipFieldNameAppendsSuffix() {
        ...
        assertEquals(
                "author" + RelationshipHandler.RELATIONSHIP_FIELD_SUFFIX,
    ...
    void inverseNameUsesMappedByWhenPresent() {
        ...
        assertEquals(
                "author_book" + RelationshipHandler.RELATIONSHIP_FIELD_SUFFIX,
