...
/**
 * Generates the single-entity delete endpoint.
 *
 * <p>The generated method handles {@code DELETE /{id}}, delegates to {@code service.delete}, and
 * returns HTTP 204 when the delete succeeds.
 */
public class DeleteEndpoint extends AbstractEndpointSpecProvider {
    /** Creates a delete endpoint provider. */
