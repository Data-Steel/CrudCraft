...
public enum DtoType {
    /** DTO type for create/update requests. */
    REQUEST(".dto.request", "RequestDto", "Create/update DTO for %s", true),
    /** DTO type for standard responses. */
    RESPONSE(".dto.response", "ResponseDto", "Response DTO for %s", false),
    /** DTO type for lightweight references. */
    REF(".dto.ref", "Ref", "Reference DTO for %s", false);

    /**
     * Package suffix for this DTO type. Used to generate package names like
     * "com.example.dto.request", "com.example.dto.response".
     */
    private final String pkgSuffix;

    /**
     * Class suffix for this DTO type. Used to generate class names like "UserRequestDto",
     * "UserResponseDto".
     */
    private final String classSuffix;

    /** Schema description for this DTO type. Used to generate OpenAPI documentation. */
    ...
    /**
     * Constructs a DTO type with the specified package suffix, class suffix, schema description,
     * and whether it is a request type.
     *
