...
public class BulkPatchEndpoint implements EndpointSpecProvider {
    ...
    public EndpointSpec create(ModelDescriptor modelDescriptor) {
        ...
        return new EndpointSpec(
                ...
                "patchAll",
                md -> AnnotationSpec.builder(EndpointSupport.PATCH_MAPPING)
                ...
                (mb, md) -> mb.addCode(
                        "requests.forEach(r -> FieldSecurityUtil.filterWrite(r.getData()));\n" +
                                "$T dtos = service.patchAll(requests).stream()\n" +
