...
public abstract class AbstractFileHeader {
    ...
    /**
     * Marker indicating that the file is editable. This is used to differentiate between files that
     * can be modified and those that should not be edited manually.
     */
    public static final String MARKER_EDITABLE = "@CrudCraft:editable";

    /**
     * Reproducible generation timestamp aligned with the root {@code project.build.outputTimestamp}
     * value. Generated sources must not embed wall-clock time.
     */
    protected static final String TIMESTAMP = "2026-01-01T00:00:00Z";

    /** Version of CrudCraft used to generate the file. */
    protected static final String VERSION = resolveVersion();

    /**
     * Private constructor to prevent instantiation of this utility class. This class is intended to
     * be extended, not instantiated directly.
     */
    protected AbstractFileHeader() {}

    /**
     * Resolves the version of CrudCraft from the package metadata. If the version cannot be
     * determined, it returns "unknown".
     *
     * @return the version string or "unknown" if not available
     */
    private static String resolveVersion() {
        String version = AbstractFileHeader.class.getPackage().getImplementationVersion();
    ...
    protected static String editableHeader(
        ...
        return editableHeader(layerType, modelClass, pkg, generatorClass, extraParagraph, "");
    }

    /**
     * Generates a header for editable files in the specified layer with an extra paragraph and
     * features.
     *
     * @param layerType the type of layer (e.g., "Controller", "Service")
     * @param modelClass the name of the model class
    ...
    protected static String editableHeader(
            ...
            String features) {
        String extra =
                (extraParagraph == null || extraParagraph.isBlank()) ? "" : extraParagraph + "\n\n";

        String feat = (features == null || features.isBlank()) ? "" : features + "\n\n";
    ...
    /**
     * Generates a strict header for model classes that should not be edited, with an extra
     * paragraph.
     *
     * @param modelClass the name of the model class
     * @param pkg the package name
    ...
    protected static String strictHeader(
            String modelClass, String pkg, String generatorClass, String extraParagraph) {
        return strictHeader(modelClass, pkg, generatorClass, extraParagraph, "");
    }

    /**
     * Generates a strict header for model classes that should not be edited, with an extra
     * paragraph and features.
     *
     * @param modelClass the name of the model class
     * @param pkg the package name
     * @param generatorClass the name of the generator class
