...
public final class LogicEditableHeader extends AbstractFileHeader {
    ...
    public static String header(
            String layerType, String modelClass, String pkg, String generatorClass) {
        String info =
                String.format(
                        "This %s stub extends CrudCraft's base implementation. "
                                + "Override protected hooks and add custom endpoints here. "
                                + "Avoid overriding generated public endpoint methods unless "
                                + "you intentionally replace the HTTP contract.",
                        layerType);
        String features =
