...
/**
 * Registry for field part extractors. Provides a mapping from field part types to their
 * corresponding extractors. This allows for dynamic extraction of field parts based on their type.
 */
public final class FieldPartExtractorRegistry {
    ...
    /**
     * A map that associates field part types with their corresponding extractors. Each extractor is
     * responsible for extracting a specific part of a field.
     */
