...
/** Singleton extractor for {@link ModelFlags}. Extracts {@link ModelFlags} from a model. */
...
public class FlagsExtractor implements ModelPartExtractor<ModelFlags> {
    ...
    /** Creates the model flags extractor. */
    ...
    public ModelFlags extract(TypeElement cls, ProcessingEnvironment env) {
        ...
        boolean abstractClass =
                cls.getModifiers().contains(javax.lang.model.element.Modifier.ABSTRACT);
