...
public final class ModelStrictHeader extends AbstractFileHeader {
    ...
    public static String header(String modelClass, String pkg, String generatorClass) {
        String info =
                "This DTO mirrors the entity fields and annotations exactly. "
                        + "Fields are nullable unless validation annotations such as @NotNull, "
                        + "@NotBlank, or @NotEmpty are present.";
        String features =
                "Included elements:\n"
                        + "- All entity fields one-to-one\n"
                        + "- Validation annotations copied verbatim\n"
                        + "- Nullness and range expectations are expressed through validation "
                        + "annotations and component Javadoc";
