...
/**
 * Shared context for writer components. Holds the processing environment and provides a helper to
 * write files with consistent error handling.
 */
public class WriteContext implements ProcessingEnvironmentProvider, ModelRegistry, JavaFileWriter {

    /**
     * The processing environment provided by the annotation processing framework. It contains
     * information about the current processing round and allows access to the file system,
     * messager, and other utilities.
     */
    private final ProcessingEnvironment env;
    private final Set<ModelDescriptor> insomniaModels;
    ...
    public WriteContext(ProcessingEnvironment env) {
        this.env = env;
        this.insomniaModels = ConcurrentHashMap.newKeySet();
    }
    ...
    public WriteContext(WriteContext other) {
        this.env = other.env;
        this.insomniaModels = ConcurrentHashMap.newKeySet();
        this.insomniaModels.addAll(other.insomniaModels);
    }

    /**
     * Creates a snapshot of the current context. Useful for passing around a consistent state
    ...
    /**
     * Returns the processing environment for this context. This is used to access the file system,
     * messager, and other utilities.
     *
    ...
    /**
     * Writes a JavaFile to the file system, handling any IO exceptions. If an error occurs, it logs
     * an error message using the processing environment's messager.
     *
