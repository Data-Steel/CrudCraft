...
/**
 * Enum representing the type of relationship between entities in a data model. This is used to
 * define how entities are related to each other, such as one-to-one, one-to-many, many-to-one, or
...
public enum RelationshipType {
    ...
    /**
     * Returns true for the relations that have a mappedBy side and thus need bidirectional
     * fix/clear.
     *
     * @return {@code true} for bidirectional relationship types
     */
    public boolean isBidirectional() {
        return this == ONE_TO_MANY || this == MANY_TO_MANY || this == ONE_TO_ONE;
    }

    /**
     * Returns the Enum constant for the given string.
     *
     * @param type relationship type name
     * @return the matching relationship type
     */
