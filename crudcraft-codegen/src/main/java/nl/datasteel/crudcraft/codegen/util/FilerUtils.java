...
public final class FilerUtils {
    ...
    /**
     * Writes the given {@link JavaFile} using the supplied {@link Filer}. Any IO error will be
     * reported through the provided {@link Messager}.
     *
    ...
    public static void writeJavaFile(JavaFile javaFile, Filer filer, Messager messager) {
        try {
            String sourceName = javaFile.packageName() + "." + javaFile.typeSpec().name();
