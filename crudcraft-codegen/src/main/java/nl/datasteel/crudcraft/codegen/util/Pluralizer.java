...
public final class Pluralizer {
    ...
    private static final Map<String, String> IRREGULAR_SINGULARS = Map.of("indices", "index");
    ...
    /**
     * Returns a singular form of the given word using a small subset of English singularization
     * rules.
     *
    ...
    public static String singularize(String word) {
        ...
        if (lower.endsWith("ies")
                && word.length() > 3
                && !isVowel(lower.charAt(lower.length() - 4))) {
