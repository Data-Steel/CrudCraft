...
/**
 * Represents a relationship between entities in a model. This includes the type of relationship,
 * the mappedBy field, the target type, and whether the target is a CRUD entity.
 *
 ...
 * @param embedded true if the relationship is modeled as embedded object
