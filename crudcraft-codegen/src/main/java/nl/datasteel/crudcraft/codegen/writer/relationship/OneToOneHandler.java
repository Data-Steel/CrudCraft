...
public class OneToOneHandler implements RelationshipHandler {
    /** Creates a one-to-one relationship handler. */
    public OneToOneHandler() {}

    /**
     * Adds the fix logic for a one-to-one relationship field. This method updates the inverse
     * relationship field of the entity.
     *
    ...
    /**
     * Adds the clear logic for a one-to-one relationship field. This method sets the inverse
     * relationship field of the entity to null.
     *
     * @param modelDescriptor the model descriptor
     * @param fieldDescriptor the field descriptor
     ...
     */
    private void writeInverseSet(
            ModelDescriptor md, FieldDescriptor fd, MethodSpec.Builder method, String rhsExpr) {
        ...
        method.addStatement(
                "@SuppressWarnings(\"unchecked\") $T child = ($T)$L.get(entity)",
                child,
                child,
                fieldName);
