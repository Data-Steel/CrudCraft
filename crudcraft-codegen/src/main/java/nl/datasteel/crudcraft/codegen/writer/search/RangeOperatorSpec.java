...
/**
 * Specification for a range operator in search requests. This operator defines a range with a start
 * and end value, allowing for filtering results based on a range of values.
 */
public class RangeOperatorSpec implements OperatorSpec {

    /** Creates a range operator spec. */
    public RangeOperatorSpec() {}
