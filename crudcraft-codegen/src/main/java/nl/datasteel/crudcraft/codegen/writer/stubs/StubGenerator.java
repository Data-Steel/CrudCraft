...
public interface StubGenerator extends Generator {
    ...
    /**
     * Generates the JavaFile for the given model descriptor. This method is called by the write
     * method to produce the files.
     *
    ...
    /**
     * Writes the generated stub files to the context. Editable stubs are written just like
     * non-editable ones; a subsequent tooling step will decide whether to keep or copy them into
