...
/**
 * Registry for model part extractors. Provides a mapping from model part types to their
 * corresponding extractors. This allows for dynamic extraction of model parts based on their type.
 */
public final class ModelPartExtractorRegistry {
    ...
    /**
     * A map that associates model part types with their corresponding extractors. Each extractor is
     * responsible for extracting a specific part of a model.
     */
    private static final Map<Class<?>, ModelPartExtractor<?>> EXTRACTORS =
            Map.of(
