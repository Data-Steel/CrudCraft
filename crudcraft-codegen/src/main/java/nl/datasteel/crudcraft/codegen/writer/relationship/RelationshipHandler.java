...
public interface RelationshipHandler {
    ...
    /** Reflection field-suffix used for cached relationship handles. */
     ...
     */
    void addFix(
            ModelDescriptor md, FieldDescriptor fd, MethodSpec.Builder fix, ClassName entityType);
     ...
     */
    void addClear(
            ModelDescriptor md, FieldDescriptor fd, MethodSpec.Builder clear, ClassName entityType);

    /**
     * Returns cached relationship field handle name.
     *
     * @param fd field descriptor
     * @return generated field-handle name
     */
    ...
    /**
     * Returns cached inverse relationship field-handle name.
     *
     * @param fd field descriptor
     * @param md model descriptor
     * @return generated inverse field-handle name
     */
