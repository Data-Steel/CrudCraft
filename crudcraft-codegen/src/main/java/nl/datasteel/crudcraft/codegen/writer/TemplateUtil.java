...
public final class TemplateUtil {
    ...
    /**
     * Private constructor to prevent instantiation. This class is a utility class and should not be
     * instantiated.
     */
    ...
    /**
     * Generates an OpenAPI Schema annotation with a list of allowable values. The values are
     * formatted as a comma-separated string enclosed in quotes.
     *
    ...
    /**
     * Generates an OpenAPI Schema annotation for a field with optional description and nullable
     * status. If description is null or empty, description is omitted.
     *
    ...
    /**
     * Generates an OpenAPI Schema annotation for an enum field with allowable values and optional
     * description.
     *
     * @param description the description to include, may be null
     ...
     * @return an AnnotationSpec for the Schema annotation
     */
    public static AnnotationSpec schemaForEnum(
    ...
    /**
     * Creates a @Schema annotation from SchemaMetadata extracted from an entity field. Merges
     * description from javadoc and @Schema annotation, with @Schema taking precedence.
     *
     ...
     */
    public static AnnotationSpec schemaFromMetadata(
            String javadoc,
